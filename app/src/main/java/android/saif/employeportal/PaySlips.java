    ...
    private void setlisteneres() {
        belllayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(PaySlips.this, NotificationActivity.class));
            }
        });
        ...
        attendance.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(PaySlips.this, "attendence clicked", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private class MyAdapter extends RecyclerView.Adapter<MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new MyViewHolder(LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.payslip, parent, false));
        }
